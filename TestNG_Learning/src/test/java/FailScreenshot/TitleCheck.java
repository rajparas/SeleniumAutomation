...

{
	...
	public void login(ITestContext i)
	{
		...
		driver.findElement(By.name("email")).sendKeys("tops123@gmail.com");
		driver.findElement(By.name("pass")).sendKeys("Tech123");
		driver.findElement(By.xpath("//*[@aria-label='Log In']")).click();
		assertEquals(driver.getTitle(), "Log into Facebook");
