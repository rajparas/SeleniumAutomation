...
public class JsonfromExternalFile 
{
	public static void main(String[] args) throws IOException 
	{
		...
		// Content of the file from external file to -> String -> Content of file can convert into Byte -> Byte data to Stirng
		
		RestAssured.baseURI ="https://rahulshettyacademy.com";
		
		String response = given().log().all().queryParam("key", "qaclick123").header("Content-Type" , "application/json")
		.body(new String(Files.readAllBytes(Paths.get("C:\\Users\\rajpa\\Desktop\\Payload.Json")))).when().post("maps/api/place/add/json")
